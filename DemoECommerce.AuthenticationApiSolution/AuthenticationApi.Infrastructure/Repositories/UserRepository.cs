...
namespace AuthenticationApi.Infrastructure.Repositories
{
    public class UserRepository(AuthenticationDbContext context, IConfiguration config) : IUser
    {
        ...
        //        clamis.Add(new(ClaimTypes.Role, user.Role!));
            ...
            var claims = new List<Claim>
    {
        ...
        public async Task<Response> Register(AppUserDTO appUserDTO)
        {
            ...
            if (getUser is not null) {
                return new Response(false, $"You cannot use this emai for registration");
            }
            ...
            return result.Entity.Id > 0 ? new Response(true, "User registered successfuly") :
